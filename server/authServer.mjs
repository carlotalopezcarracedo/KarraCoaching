...
const defaultResourceVideoUrlByKey = new Map([
  ...
  [normalizeResourceKey('press militar'), '/press-militar.gif'],
  [normalizeResourceKey('press frances'), '/press-frances.gif'],
  [normalizeResourceKey('curl con barra'), '/curl-barra.gif'],
  [normalizeResourceKey('curl concentrado'), '/curl-concentrado.gif'],
  [normalizeResourceKey('curl martillo'), '/curl-martillo.gif'],
  ...
  [normalizeResourceKey('elevaciones de piernas'), '/elevaciones-piernas.gif'],
  [normalizeResourceKey('peso muerto sumo'), '/peso-muerto-sumo.gif'],
  [normalizeResourceKey('peso muerto rumano'), '/peso-muerto-rumano.gif'],
  [normalizeResourceKey('hip thrust'), '/hip-thrust.gif'],
  [normalizeResourceKey('hack squat'), '/hack-squat.gif'],
  [normalizeResourceKey('bulgaras'), '/bulgaras.gif'],
  [normalizeResourceKey('extension de cuadriceps'), '/extension-cuadriceps.gif'],
  [normalizeResourceKey('curl femoral'), '/curl-femoral.gif'],
